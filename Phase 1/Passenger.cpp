...
void Passenger:: print_discount_code()
{
  cout<<PassengerDiscountCode.get_code()<<" "<<PassengerDiscountCode.get_available_count()<<endl;
}
...
void Passenger:: print_trip_request()
{
	cout<<"["<<Username<<" ";
		RequestedTrip->print_trip();
	cout<<"]"<<endl;
}
...
void Passenger:: print_last_accepted_trip()
{
	if(AcceptedTrip!=NULL)
		AcceptedTrip->print_trips_driver_details();
}
...
void Passenger:: print_credit()
{
	cout<<credit+DiscountedCredit<<endl;
}
