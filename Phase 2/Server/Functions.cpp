...
string GetGalaxy(string Address)
{
	return GetSubStrFromLine(Address,',');

}
bool pred(FindingDriverHelpingClass &F1, FindingDriverHelpingClass &F2)
{
	return F1.get_magic_num() > F2.get_magic_num();
}